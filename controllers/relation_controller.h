...
#ifndef PIGRAID_FRIEND_SERVICE_RELATION_CONTROLLER_H
#define PIGRAID_FRIEND_SERVICE_RELATION_CONTROLLER_H
...
#endif //PIGRAID_FRIEND_SERVICE_RELATION_CONTROLLER_H
